			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
                        ...
                        <div class="panel panel-default">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="farms.php?type=1">جدولة المشتريات</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="farmer life.php?type=1">تجربة المزارع</a></h4>
								</div>
							</div>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">المزارع</h2>

						<?php
                            $sql = "SELECT * FROM farms WHERE type = $type ORDER BY id DESC";
